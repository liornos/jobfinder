...
def fetch_jobs(org: str, *, limit: Optional[int] = None) -> List[Dict[str, Any]]:
    ...
    for pattern in API_PATTERNS:
        try:
            ...
            job_list = data.get("searchResults") or data.get("jobs") or data.get("data") or []
            ...
            for j in job_list:
                jobs.append({
                    ...
                    "url": j.get("jobUrl") or j.get("url") or f"https://careers-{org}.icims.com/jobs/{j.get('jobId') or j.get('id')}",
